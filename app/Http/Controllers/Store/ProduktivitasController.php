...
class ProduktivitasController extends Controller
{
    ...
    {     
        ...
        if($request->id_jenis_alat[1] == "Hydraulic Excavator"){
            ...
            $siklus_pengisian = ($request->dump["kapasitas_dump"]/$tipeAlat->kapasitas_bucket) * $request->dump["bucket_fill_factor"];
            $produktivitas_per_siklus = round($siklus_pengisian,0) * $tipeAlat->kapasitas_bucket * $request->dump["bucket_fill_factor"];
