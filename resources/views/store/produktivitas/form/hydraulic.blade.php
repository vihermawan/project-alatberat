  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      <input v-model="form.hydraulic.conversion_factor" id="conversion_factor" type="number" step="0.01" min=0 placeholder="Masukkan conversion factor"
          class="form-control" :class="{ 'is-invalid': form.errors.has('conversion_factor') }">
      <has-error :form="form" field="conversion_factor"></has-error>
    </div>
  </div>
  <div class="form-row">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      <input v-model="form.hydraulic.faktor_kedalaman" id="faktor_kedalaman" type="number" step="0.01" min=0 placeholder="Masukkan faktor kedalaman"
          class="form-control" :class="{ 'is-invalid': form.errors.has('faktor_kedalaman') }">
      <has-error :form="form" field="faktor_kedalaman"></has-error>
    </div>
  </div>
  <div class="form-row">
    ...
    <div class="form-group col-md-8">
      <input v-model="form.hydraulic.faktor_efisiensi_kerja" id="faktor_efisiensi_kerja" type="number" step="0.01" min=0 placeholder="Masukkan faktor efisiensi kerja"
          class="form-control" :class="{ 'is-invalid': form.errors.has('faktor_efisiensi_kerja') }">
      <has-error :form="form" field="faktor_efisiensi_kerja"></has-error>
    </div>
  </div>
</div>