      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-10">
              <div class="form-group">
                  <input type="number" step="0.01" class="form-control" v-model="form.bulldozer.fuel_filter_element.interval" id="interval"
                  :class="{ 'is-invalid': form.errors.has('bulldozer.fuel_filter_element.interval') }"    
